...
% Auto-generated by MATLAB on 06-Mar-2023 13:34:05
...
predictorNames = {'xval', 'Conductivity (mS/cm)', 'Density (g/cm3)', 'Dynamic viscosity (mPa.s)', 'pH'};
predictors = inputTable(:, predictorNames);
response = inputTable.yval;
...
trainedModel.RequiredVariables = {'Conductivity (mS/cm)', 'Density (g/cm3)', 'Dynamic viscosity (mPa.s)', 'pH', 'xval'};
