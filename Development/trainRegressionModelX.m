...
% Auto-generated by MATLAB on 06-Mar-2023 12:30:30
...
predictorNames = {'Conductivity (mS/cm)', 'Density (g/cm3)', 'Dynamic viscosity (mPa.s)', 'pH'};
predictors = inputTable(:, predictorNames);
response = inputTable.xval;
...
trainedModel.RequiredVariables = {'Conductivity (mS/cm)', 'Density (g/cm3)', 'Dynamic viscosity (mPa.s)', 'pH'};
